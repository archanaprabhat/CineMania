...
export default function StatsSection({ movieCount, showCount, actorCount, genreCount }: StatsSectionProps) {
  ...
  const stats = [
    ...
    { label: "Genres", value: genreCount, icon: Layers, color: "text-yellow-400" },
  ]
      ...
      <div ref={ref} className="container mx-auto px-4 relative z-10">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-12">
          {stats.map((stat, index) => (
            ...
            >
              <div className={`p-4 rounded-2xl bg-white/5 border border-white/5 mb-4 group-hover:scale-110 transition-transform duration-300 ${stat.color}`}>
