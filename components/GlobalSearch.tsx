    ...
    >
      <div className={cn(
        ...
        <Input
          ...
          className="pl-9 pr-9 h-10 w-full bg-background/50 backdrop-blur-md border-white/10 focus-visible:ring-white/20 focus-visible:border-white/30 transition-all rounded-full"
          value={query}
        ...
        {isLoading ? (
          ...
          <Button
            ...
            variant="ghost"
            size="icon"
            className="absolute right-1 h-8 w-8 text-muted-foreground hover:text-white rounded-full"
            onClick={clearSearch}
          >
            <X className="h-4 w-4" />
      ...
      {suggestions.length > 0 && isExpanded && (
        <div className="absolute top-12 left-0 w-full bg-black/90 backdrop-blur-xl border border-white/10 rounded-xl overflow-hidden shadow-2xl animate-in fade-in zoom-in-95 duration-200">
          <div className="max-h-[60vh] overflow-y-auto py-2">
            ...
            <button
              type="submit"
              className="w-full text-center py-3 text-sm text-primary hover:bg-white/5 transition-colors border-t border-white/5"
            >
