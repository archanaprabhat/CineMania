...
export function DetailHero({ title, tagline, backdropPath, posterPath, children, actions }: DetailHeroProps) {
        ...
        <div className="flex flex-col md:flex-row gap-8 items-end w-full">
          ...
          <div className="space-y-6 max-w-4xl flex-1">
            <div className="space-y-2">
              ...
              {tagline && (
                <p className="text-xl md:text-2xl text-gray-300 italic font-light tracking-wide">{tagline}</p>
              )}
            </div>
